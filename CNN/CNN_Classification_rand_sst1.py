...
with tf.device('device:GPU:0'):
    tf.set_random_seed(667)  # reproducibility
    ...
    embedding_matrix = tf.get_variable("embedding_matrix", shape=[vocabulary_size, embedding_size],
                         initializer=tf.contrib.layers.xavier_initializer())
    #embedding_matrix=tf.Variable(tf.random_normal([vocabulary_size, embedding_size], stddev=0.01))
