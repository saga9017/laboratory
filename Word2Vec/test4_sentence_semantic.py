...
for i in range(len(input)):
    ...
    sentence_semantic=np.sum([loaded_matrix[loaded_dic[i]] for i in output_words ], axis=0)
...
save('saved_matrix/text8_test4_sentence_semantic_meaning5')
