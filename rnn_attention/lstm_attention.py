...
class RNN_attention:
    ...
    def forward_propagation(self, x, y):
        ...
        return [output, result, alpha, h, s, c, c_ , o, i, f, g, o_, i_, f_, g_]
    ...
    def bptt(self, x, y):
        ...
        output, result, alpha, h, s, c, c_ , o, i, f, g, o_, i_, f_, g_ = self.forward_propagation(x, y)
    ...
    def calculate_total_loss(self, x, y):
        ...
        for i in np.arange(len(y)):
            output, _, _, _, _, _, _ , _, _, _, _, _, _, _, _  = self.forward_propagation(x[i], y[i])
            y_=y[i][1:]
            y_.append(1)
    ...
    def gradient_check_loss(self, x, y):
        L = 0
        # For each sentence...
        output, _, _, _, _, _, _ , _, _, _, _, _, _, _, _  = self.forward_propagation(x, y)
        y_=y[1:]
        y_.append(1)
        # We only care about our prediction of the "correct" words
