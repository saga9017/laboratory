    ...
    def train_with_batch(self, info, batch_val, optimizer):
        ...
        for epoch in range(nepoch):
            ...
            for i in range(len(batch_train)):
                ...
                if num_examples_seen % 300 == 0:  # origin = int(batch_len * nepoch / 100)
            ...
            }, 'project4_1_checkpoint/epoch='+str(epoch))
...
if __name__ == '__main__':
    ...
    new_test_loc_list=[]
    test_label = []
    for idx, i in enumerate(test_data_text):
        new_test_loc_text_list.append([idx] + tokenizer.encode(i[0]))
    ...
    batch_test = generate_batch(new_test_loc_text_list, new_test_loc_list, test_data, hashtag_size)
    ############################################################################
    ...
    for idx, i in enumerate(train_data_text):
        new_train_loc_text_list.append([idx] + tokenizer.encode(i[0]))
    ...
    val_precision = model.train_with_batch((new_train_loc_text_list, new_train_loc_list, train_data, hashtag_size), batch_val, optimizer)
