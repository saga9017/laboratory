"""""""""""""""""""""""""""
using pre-trained bert, using cls for prediction, fine-tuning, using text, trained image feature + location + knowledge + focal_loss
...
class BERTLM_new(nn.Module):
    ...
    def train_with_batch(self, info, batch_val, optimizer):
        ...
        for epoch in range(nepoch):
            ...
            }, 'project3_bert21_checkpoint/epoch='+str(epoch))
