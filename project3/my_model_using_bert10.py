"""""""""""""""""""""""""""
using pre-trained bert, using cls for prediction, freeze, only using image
...
class BERTLM(nn.Module):
    ...
    def forward(self, batch_text, batch_img, batch_loc, batch_know, segment, dropout):
        ...
        x=self.transformer(new_batch_img, dropout)
    ...
    def train_with_batch(self, info, batch_val, optimizer):
        ...
        for epoch in range(nepoch):
            ...
            }, 'project3_bert10-2_checkpoint/epoch='+str(epoch))
...
if __name__ == '__main__':
    ...
    checkpoint = torch.load('project3_bert10_checkpoint/train_65')
