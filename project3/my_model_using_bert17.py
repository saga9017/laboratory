"""""""""""""""""""""""""""
using pre-trained bert, using cls for prediction, freeze, using text, trained image feature + location
...
class BERTLM_new(nn.Module):
    ...
    def forward(self, batch_loc_text, batch_img, batch_know, segment, dropout):
        ...
        x=self.transformer_new(x, batch_img, attention_mask, dropout)
    ...
    def train_with_batch(self, info, batch_val):
        ...
        for epoch in range(nepoch):
            ...
            }, 'project3_bert17_checkpoint/epoch='+str(epoch))
...
if __name__ == '__main__':
    ...
    val_precision = model.train_with_batch((new_train_loc_text_list, new_train_loc_list, train_data, len(hashtagVoc)), batch_val)
