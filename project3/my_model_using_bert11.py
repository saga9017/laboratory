"""""""""""""""""""""""""""
using pre-trained bert, using cls for prediction, fine-tuning, using text, trained image by transformer
...
class BERTLM_new(nn.Module):
    ...
    def __init__(self, vocab_size):
        ...
        checkpoint = torch.load('project3_bert10_checkpoint/epoch=' + str(753))
    ...
    def forward(self, batch_text, batch_img, batch_loc, batch_know, segment, dropout):
        ...
        x=self.transformer_new(x, new_batch_img, attention_mask, dropout)
    ...
    def train_with_batch(self, info, batch_val):
        ...
        optimizer = torch.optim.Adam(model.parameters(), betas=(0.9, 0.999), eps=1e-9, lr=5e-5)
        Loss_len = 0
        num_examples_seen = 1
        # nepoch=nb_epoch()
        nepoch = 1000
        ...
        for epoch in range(nepoch):
            ...
            }, 'project3_bert11_checkpoint/epoch='+str(epoch))
