...
class BERTLM(nn.Module):
    ...
    def train_with_batch(self, batch_train, batch_val):
        ...
        optimizer = torch.optim.Adam(model.parameters(), betas=(0.9, 0.999), eps=1e-9, lr=0.0)
        Loss_len = 0
        num_examples_seen = 1
        #nepoch=nb_epoch()
        nepoch =1000
...
if __name__ == '__main__':
    ...
    batch_train = generate_batch(new_train_text_list, train_data, len(hashtagVoc))
    ...
    val_precision = model.train_with_batch(batch_train, batch_val)
