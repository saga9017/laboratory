...
single modal pretraining and fine-tuning same task(hashtag recommendation)
...
if __name__ == '__main__':
    ...
    ############################################################################
    batch_val = generate_batch(new_test_loc_text_list, new_test_loc_list, test_data, len(hashtagVoc))
    ############################################################################
    ...
    checkpoint = torch.load('project3_bert22_checkpoint/epoch=9')
