"""""""""""""""""""""""""""
batch suffle, encoder 6, fixed learning rate, reduce hidden_dim
...
class Bert(nn.Module):
    ...
    def input_embedding(self, batch_text, batch_img, batch_loc, batch_know, segment):  # x: (batch, input_len, )
        ...
        mixed=torch.cat([self.token_embed(batch_loc), self.know_embed(batch_know), new_batch_img,
...
class BERTLM(nn.Module):
    ...
    def train_with_batch(self, info, batch_val):
        ...
        optimizer = torch.optim.Adam(model.parameters(), betas=(0.9, 0.999), eps=1e-9, lr=0.005)
        Loss_len = 0
        num_examples_seen = 1
        #nepoch=nb_epoch()
        nepoch =1000
        ...
        for epoch in range(nepoch):
            ...
            }, 'project3_5_checkpoint/epoch='+str(epoch))
