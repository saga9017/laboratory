...
class BERTLM_new(nn.Module):
    ...
    def train_with_batch(self, info, batch_val, optimizer):
        ...
        for epoch in range(nepoch):
            ...
            }, 'project3_bert19_2_checkpoint/epoch='+str(epoch))
...
if __name__ == '__main__':
    ...
    optimizer = torch.optim.Adam(model.parameters(), betas=(0.9, 0.999), eps=1e-9, lr=1e-6)
    checkpoint = torch.load('project3_bert19_checkpoint/epoch=23')
